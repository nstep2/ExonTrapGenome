...
suffix = '_1.fastq.gz_all_trimmed_simple_paired.sam.gz'
...
collapsed_exons_list = [ [input_file_name_list[ii][1],  backbone_dict[input_file_name_list[ii][0]] , x] for  ii, x in enumerate(collapsed_exons_list)]
